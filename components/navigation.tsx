      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-12">
            {[
              { name: "Metodologia", href: "#process-section" },
              { name: "Casos", href: "#testimonials-section" },
              { name: "Sobre", href: "#features-section" },
            ].map((item) => (
              <a
                key={item.name}
                href={item.href}
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Button
              ...
              onClick={() => {
                const ctaSection = document.querySelector("form") || document.getElementById("cta-section")
